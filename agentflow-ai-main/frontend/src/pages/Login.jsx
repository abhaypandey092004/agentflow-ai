  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-slate-500 font-medium mt-1">Access your autonomous neural network.</p>
      </div>
      ...
      <div className="text-center pt-4">
        <p className="text-sm font-medium text-slate-500">
          New Operator?{' '}
          <Link to="/register" className="font-black text-primary-400 hover:text-primary-300 transition-colors underline underline-offset-4 decoration-primary-400/30">
            Apply for Access
          </Link>
        </p>
      </div>
