...
const MainLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-transparent font-sans">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 transform glass transition-all duration-200 lg:static lg:translate-x-0 ${
      ...
      >
        <div className="flex h-20 items-center justify-between border-b border-white/5 px-8">
          <Link
            to="/dashboard"
            onClick={() => setSidebarOpen(false)}
            className="text-2xl font-black text-gradient tracking-tighter hover:opacity-80 transition-opacity"
          >
            AgentFlow AI
          </Link>
